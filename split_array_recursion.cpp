...
int count(int *arr,int *ans1,int *ans2,int i,int j1,int j2,int num){
	...
	int n2=count(arr,ans1,ans2,i+1,j1,j2,num);
	int n3=count(arr,ans1,ans2,i+1,j1,j2,num);
	ans2[j2]=arr[i];
	int n4=count(arr,ans1,ans2,i+1,j1,j2+1,num);
	return n1+n2+n3+n4;
}
...
void subsets(int *arr,int *ans1,int *ans2,int i,int j1,int j2,int num){
	...
	subsets(arr,ans1,ans2,i+1,j1,j2,num);
	subsets(arr,ans1,ans2,i+1,j1,j2,num);
	ans2[j2]=arr[i];
