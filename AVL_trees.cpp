...
public:
   ...
   //we have to first do the left-right case
    //or the right -left case
    // and second we have to do the right-left case
    //or left-right case 
    //coz if we dont then the condition will
    //always hits then left left and right right always
    //so it means its an overlapping problem
    //solved by mohammed qubaisuddin
